...
export class newBooksComponent {
  ...
  fetchBooks() {
    ...
    this.webService
      .getNewBooks(this.page, titleFilterLower, authorFilterLower, genreFilterLower, characterFilterLower)
      .subscribe((response) => {
  ...
  applyFilters() {
    this.page = 1;
    this.router.navigate(['/new-books'], { queryParams: { title: this.titleFilter, genre: this.genreFilter, author: this.authorFilter, character: this.characterFilter } });
    this.fetchBooks();
  }
